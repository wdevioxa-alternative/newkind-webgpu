...
{	uint32_t buffer [3], format ;
	...
	if (buffer [0] == MAKE_MARKER ('I', 'D', '3', 0x0))
		return SF_FORMAT_MP3;

	if (buffer [0] == MAKE_MARKER ('I', 'D', '3', 0x1))
		return SF_FORMAT_MP3;

	if (buffer [0] == MAKE_MARKER ('I', 'D', '3', 0x2))
		return SF_FORMAT_MP3;

	if (buffer [0] == MAKE_MARKER ('I', 'D', '3', 0x3))
		return SF_FORMAT_MP3;

	if (buffer [0] == MAKE_MARKER ('I', 'D', '3', 0x4))
		return SF_FORMAT_MP3;
...
////////////////////////////////////////////////////////////////
//	printf( "fileoffset: %lld\n", psf->fileoffset );
//	printf( "filelength: %lld\n", psf->filelength );

//	printf( "datalength: %lld\n", psf->datalength );
//	printf( "dataoffset: %lld\n", psf->dataoffset );

//	printf( "blockwidth: %lld\n", psf->blockwidth );
//	printf( "bytewidth: %lld\n", psf->bytewidth );
////////////////////////////////////////////////////////////////
