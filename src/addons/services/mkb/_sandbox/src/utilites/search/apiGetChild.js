...
/**
 * @description Getting an entity from the linearezation table with /other.
...
*/
export async function apiGetChild(uri) {
	const links = useLinks()
	return await axios.get(`${uri}/other`, links.optionsGetEntity);
};
