...
export const PreviewChangeRecord = () => {
            ...
            if (id) {
              const entityData = await axiosInstance
                .get(
                  ...
                  params.releaseGroup === "testing"
                    ? `/testing/v1/icd/entity/${id}?releaseId=${params.releaseId}`
                    : `/v1/icd/entity/${id}?releaseId=${params.releaseId}`,
                  {
                    headers: {
                      "Accept-Language": `${params.releaseLang}`,
                    },
    ...
    <div className={styles.ChangesReviewPage}>
      ...
      <div className={styles.header}>
        <div className={styles.headerTop}>
          <h2 className={styles.title}>Просмотр изменений записи</h2>
