...
export const InputSearchWithRelease = (props) => {
    const { setDeseaseData, releaseGroup, releaseId, releaseLang, forcePassedLabel } = props
    ...
    const [text, setText] = useState(forcePassedLabel || '');
    ...
    useEffect(() => setText(forcePassedLabel), [forcePassedLabel])
