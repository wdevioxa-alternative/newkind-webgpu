...
export const External = () => {
    ...
    html.style.setProperty('--rem', `${root}`)
    ...
    //     console.log('------------ onbeforeunload ---------------', window[children])
        // if(!isEmpty(window[children])) {
                                                ...
                                                <div className={`${style.decoding} ${style.decoding_outside}`}>
                                                    {!isEmpty(tree.keys) &&
                                                        <div className={style.resultSearch}>
                                                            ...
                                                            >
                                                                <div className={style.postCoordinationCodeString}>
                                                                    {requestData[0].text}
                                                                </div>
                                                                <div
                                                                ...
                                                                >
                                                                    <Link
                                                                        to={ tree.value[tree.keys[0]].id }
                                                                        target={"_blank"}
                                                                        className={`${style.editorDescription}`}
                                                                    >
                                                                        {tree.value[tree.keys[0]].title}
                                                                    </Link>

                                                                    {/*{requestData.map(chank => {*/}
                                                                    {/*    console.log('---------------- !!! --------------',tree.value[tree.keys[0]].title)*/}
                                                                    {/*    return (*/}
                                                                    {/*        <p*/}
                                                                    {/*            key={idKey()}*/}
