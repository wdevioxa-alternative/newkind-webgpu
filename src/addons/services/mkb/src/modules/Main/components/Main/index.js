...
export const Main = ({ className, uri, id, type, ismobileleftmenu, setmobileleftmenu, isCodingPage = false, setCodingModal, codeDiseaseChoice }) => {
    ...
    const onClickHeandler = async () => {
        ...
        analytics.identify(user, {
            ...
            action: window.location.pathname.startsWith('/coding') ? 'coding_copy_postcoordination_code ' : 'copy_postcoordination_code'
        })
                                                                ...
                                                                >
                                                                    ...
                                                                    {item.isNextLayer ? (
                                                                        <Editor
                                                                            ...
                                                                            setHeight={setHeight}
                                                                            title={item.title}
                                                                            postcoordinationTree={page.postcoordinationTree}
                                                                            postcoordination={{
                                                                                title: item.title,
