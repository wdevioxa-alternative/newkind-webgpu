...
export default class Parameters extends Component {
  ...
  render() {
    ...
    api.parameters[`${pathMethod[0]}`] = {
      path: this.props.pathMethod[0],
      method: this.props.pathMethod[1]
    }

    api.parameters[`${this.props.pathMethod[0]}`][`${this.props.pathMethod[1]}`].onChangeBody.swagger = onChangeBody
          ...
          <div className="opblock-section opblock-section-request-body">
            ...
            <div className="opblock-description-wrapper">
              <RequestBody
                ...
                onChange={api.parameters[`${this.props.pathMethod[0]}`][`${this.props.pathMethod[1]}`].onChangeBody.service}
