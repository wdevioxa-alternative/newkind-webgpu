...
export class JsonSchema_string extends Component {
  ...
  // getStore().api.parameters.onChange.swagger = this.onChange
  render() {
    ...
    api.jsonSchemaComponents[`${this.props.pathMethod[0]}`] = {
    ...
    if(enumValue) {
      api.jsonSchemaComponents[`${this.props.pathMethod[0]}`][`${this.props.pathMethod[1]}`][`${this.props.description}`].onEnumChange.swagger = this.onEnumChange
    } else {
      api.jsonSchemaComponents[`${this.props.pathMethod[0]}`][`${this.props.pathMethod[1]}`][`${this.props.description}`].onChange.swagger = this.onChange
    }
    ...
    if ( enumValue ) {
      ...
      return (<Select className={ errors.length ? "invalid" : ""}
                      ...
                      disabled={disabled}
                      onChange={ api.jsonSchemaComponents[`${this.props.pathMethod[0]}`][`${this.props.pathMethod[1]}`][`${this.props.description}`].onEnumChange.service }/>)
    }
    ...
    if (type && type === "file") {
      return (
        <Input type="file"
          ...
          title={errors.length ? errors : ""}
          onChange={api.jsonSchemaComponents[`${this.props.pathMethod[0]}`][`${this.props.pathMethod[1]}`][`${this.props.description}`].onChange.service}
          disabled={isDisabled} />
      )
    }
    else {
