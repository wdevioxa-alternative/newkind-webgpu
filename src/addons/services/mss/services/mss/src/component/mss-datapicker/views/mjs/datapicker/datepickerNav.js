...
export default class DatepickerNav {
    ...
    _defineDOM() {
        // this.$months = getEl('.air-datepicker-nav--months', this.$el);
    ...
    _bindEvents() {
        ...
        // this.$months.addEventListener('click', this.onClickNavTitle);
    }
    ...
    _buildBaseHtml() {
        ...
        // this.$el.innerHTML = '' +
        //     `<select class="air-datepicker-nav--months">
    ...
    render = () => {
        ...
        // this.$title.innerHTML = this._getMonths();
