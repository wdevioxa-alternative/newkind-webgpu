...
export default () => {
    return new Promise(async (resolve, reject) => {
        ...
        let self = {
            ...
            dom: (win = document, params ="default" | {
                status: undefined,
                progress: undefined,
                spinner: undefined,
                canvas: undefined,
                ...
                return new Promise(async (resolve, reject) => {
                    if(params === 0) {
                        self.data.status = win.getElementById('status');
                        self.data.progress = win.getElementById('progress');
                        self.data.spinner = win.getElementById('spinner');
                        self.data.element = win.getElementById('output');
                        self.data.canvas = win.getElementById('canvas');
